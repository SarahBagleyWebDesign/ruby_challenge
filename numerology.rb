...
def get_message(birth_path_num)
	...
	when 9
		...
		message = "Uh oh! Your birth path number is not 1–9! I have no idea what this means for your LIFE!!!?"
	end
end

puts "What is your birthday? Please format it as such: MMDDYYYY. Thanks!"
birthday = gets
